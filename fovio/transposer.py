...
NE = []
SE = []
table_coord = "%s\\%s\\table_coordinates.csv" % (PATH, args.user)
...
# Initial Fovio data
datacsv = "%s\\%s\\%s\\table.csv" % (PATH, args.user, args.figure)
...
data_transposed = "%s\\%s\\%s\\table_transposed.csv" % (PATH, args.user, args.figure)
